...
func main() {
	...
	dsn := "root:xxx@tcp(127.0.0.1:3305)/db1?charset=utf8mb4&parseTime=True&loc=Local"
	// 简单连接
...
// 创建表 自动迁移 把结构体和表进行对应
	...
	//db.Create(&info)
	//defer
	var users = []UserInfo{{Name: "jinzhu1", Gender: "男", Hobby: ""},
		{Name: "jinzhu2", Gender: "男", Hobby: ""},
		{Name: "jinzhu3", Gender: "女", Hobby: ""}}
	db.Create(&users)
}
